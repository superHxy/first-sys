                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <a href="edit.php?id=<?= htmlspecialchars($schedules[$i]['id']); ?>" class="text-blue-600 hover:underline">Edit</a> | 
                                <a href="delete.php?id=<?= htmlspecialchars($schedules[$i]['id']); ?>" class="text-red-600 hover:underline" onclick="return confirm('Are you sure?');">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
